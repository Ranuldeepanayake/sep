...
--
-- Host: mysql-1
-- Generation Time: Feb 11, 2022 at 05:20 AM
...
CREATE TABLE `item` (
  ...
  `image` varchar(75) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT 'Path of the image file.',
...
(6, 'Other', 'Vitamin C', 'Vitamin C', 'false', 250, 25, './html/uploads/b42a86f2a527060582fac505623c36b3.jpg', 32);
...
INSERT INTO `supplier` (`supplier_id`, `nmra_registration`, `pharmacist_registration`) VALUES
(3, 'AB1956PQR78', '12237945HXLO'),
(17, 'GQ1286PSR98', '91137845TXRX'),
(21, 'GQ1286PSR98', '91137845TXRX'),
(32, 'KS1286ABC12', '11579845TXRJ');
...
(17, 'supplier', 'shamal@gmail.com', 'Shamal', 'Manawadu', 'Main road', 'Kottawa', 'shamal@123'),
(21, 'supplier', 'Jehan@gmail.com', 'Jehan', 'R', 'Main road', 'Kottawa', 'jehan@123'),
(32, 'supplier', 'anish@gmail.com', 'Anish', 'C', 'Main street', 'Rajagiriya', 'anish@123');
...
--
ALTER TABLE `item`
  MODIFY `item_code` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
